"""
Adopted from: https://github.com/python/cpython/blob/3.12/Lib/test/test_deque.py
"""

from deque_one import deque
import doctest
import unittest
...
class TestBasic(unittest.TestCase):
    ...
    def test_maxlen(self):
        ...
        self.assertRaises(ValueError, deque, "abc", None)
        self.assertRaises(ValueError, deque, "abc", maxlen=1)
        self.assertRaises(ValueError, deque, "abc", maxlen=None)
        self.assertRaises(ValueError, deque, iterable="abc", maxlen=1)
        self.assertRaises(ValueError, deque, iterable="abc", maxlen=None)
        # self.assertRaises(ValueError, deque, 'abc', -1)
    ...
    def test_maxlen_attribute(self):
        ...
        self.assertEqual(deque(iterable="abc").maxlen, None)
        # self.assertEqual(deque().maxlen, None)
